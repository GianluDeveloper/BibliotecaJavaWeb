...
public class ResponseContoCorrente extends service.Response implements java.io.Serializable {
	...
	public ResponseContoCorrente(java.lang.String description, int errorCode, boolean successo,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ResponseContoCorrente))
			return false;
		...
		_equals = super.equals(obj)
				&& ((this.contoCorrente == null && other.getContoCorrente() == null) || (this.contoCorrente != null
	...
	public synchronized int hashCode() {
		...
		if (getContoCorrente() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getContoCorrente()); i++) {
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ResponseContoCorrente.class, true);
