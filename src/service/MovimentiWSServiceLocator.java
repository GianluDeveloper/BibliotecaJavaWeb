...
public class MovimentiWSServiceLocator extends org.apache.axis.client.Service implements service.MovimentiWSService {
	...
	public MovimentiWSServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName)
	...
	public service.MovimentiWS getMovimentiWSPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
		try {
			service.MovimentiWSServiceSoapBindingStub _stub = new service.MovimentiWSServiceSoapBindingStub(portAddress,
					this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
		try {
			if (service.MovimentiWS.class.isAssignableFrom(serviceEndpointInterface)) {
				service.MovimentiWSServiceSoapBindingStub _stub = new service.MovimentiWSServiceSoapBindingStub(
						new java.net.URL(MovimentiWSPort_address), this);
				_stub.setPortName(getMovimentiWSPortWSDDServiceName());
				return _stub;
			}
