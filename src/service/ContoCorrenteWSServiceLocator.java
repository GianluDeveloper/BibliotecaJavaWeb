...
public class ContoCorrenteWSServiceLocator extends org.apache.axis.client.Service
		implements service.ContoCorrenteWSService {
	...
	public ContoCorrenteWSServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName)
	...
	public service.ContoCorrenteWS getContoCorrenteWSPort(java.net.URL portAddress)
			throws javax.xml.rpc.ServiceException {
		try {
			service.ContoCorrenteWSServiceSoapBindingStub _stub = new service.ContoCorrenteWSServiceSoapBindingStub(
					portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
		try {
			if (service.ContoCorrenteWS.class.isAssignableFrom(serviceEndpointInterface)) {
				service.ContoCorrenteWSServiceSoapBindingStub _stub = new service.ContoCorrenteWSServiceSoapBindingStub(
						new java.net.URL(ContoCorrenteWSPort_address), this);
				_stub.setPortName(getContoCorrenteWSPortWSDDServiceName());
				return _stub;
			}
