...
public class ResponseTipoMovimento extends service.Response implements java.io.Serializable {
	...
	public ResponseTipoMovimento(java.lang.String description, int errorCode, boolean successo,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ResponseTipoMovimento))
			return false;
		...
		_equals = super.equals(obj)
				&& ((this.tipoMovimento == null && other.getTipoMovimento() == null) || (this.tipoMovimento != null
	...
	public synchronized int hashCode() {
		...
		if (getTipoMovimento() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getTipoMovimento()); i++) {
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ResponseTipoMovimento.class, true);
