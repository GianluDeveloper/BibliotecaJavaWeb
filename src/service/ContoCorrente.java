...
public class ContoCorrente implements java.io.Serializable {
	...
	public ContoCorrente(java.lang.String dataCreazione, int iban, int idCliente, float saldo) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = true
				&& ((this.dataCreazione == null && other.getDataCreazione() == null)
						|| (this.dataCreazione != null && this.dataCreazione.equals(other.getDataCreazione())))
				&& this.iban == other.getIban() && this.idCliente == other.getIdCliente()
