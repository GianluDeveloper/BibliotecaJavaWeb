...
public class ClienteDao {
	...
	public boolean update(Cliente d) {
		Object[] campiString = { d.getNome(), d.getCognome(), d.getTelefono(), d.getIdCliente() };
		ObjSql connettore = new ObjSql();
	...
	public Cliente findById(int id) {
		...
		ObjSql connettore = new ObjSql();
		String sql = "SELECT `idCliente`, `nome`, `cognome`, `telefono` FROM `cliente` " + "WHERE `idCliente`= ?";
		boolean resp = connettore.sql(sql, campiString);
	...
	public List<Cliente> findBykv(String k, String v) {
		...
		ObjSql connettore = new ObjSql();
		String sql = "SELECT `idCliente`, `nome`, `cognome`, `telefono` FROM `cliente` " + "WHERE `" + k + "`=?";
	...
	public List<Cliente> findAll() {
		...
		ObjSql connettore = new ObjSql();
		String sql = "SELECT `idCliente`, `nome`, `cognome`, `telefono` FROM `cliente` " + "WHERE ?";
		boolean resp = connettore.sql(sql, campiString);
