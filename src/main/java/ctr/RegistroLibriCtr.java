...
public class RegistroLibriCtr extends HttpServlet {
	...
	private void insert(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		String data_prestito = request.getParameter("data_prestito"),
				data_scadenza = request.getParameter("data_scadenza"),
		...
		if (idLibro != null && idCliente != null && idDipendente != null && data_prestito != null
			...
			Registro d = new Registro(0, idLibroInt, idClienteInt, idDipendenteInt, data_prestito, data_scadenza,
					data_rientro);
	...
	private void update(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		if (idLibro != null && idCliente != null && idDipendente != null && data_prestito != null
			...
			Registro d = new Registro(id, idLibroInt, idClienteInt, idDipendenteInt, data_prestito, data_scadenza,
					data_rientro);
