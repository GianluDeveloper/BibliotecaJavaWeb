...
public class TurniCtr extends HttpServlet {
	...
	private void insert(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		String data_inizio = request.getParameter("data_inizio"), data_fine = request.getParameter("data_fine");
	...
	private void findById(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		if (turno != null) {
			...
			String html = "";
			html += "idTurno: " + res.getIdTurni() + " idDipendente: " + res.getIdDipendente() + " dataInizio: "
					+ res.getData_inizio() + " data fine: " + res.getData_fine();
