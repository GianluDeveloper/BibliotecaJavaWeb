...
public class LibriDao {
	...
	public boolean insert(Libri d) {
		Object[] campiString = { d.getNumPagine(), d.getAnno(), d.getPosizione(), d.getTitolo(), d.getGenere(),
				d.getAutore(), d.getIsbn(), d.getCasaEditrice() };
	...
	public boolean update(Libri d) {
		Object[] campiString = { d.getNumPagine(), d.getAnno(), d.getPosizione(), d.getTitolo(), d.getGenere(),
				d.getAutore(), d.getIsbn(), d.getCasaEditrice(), d.getIdLibro() };
		ObjSql connettore = new ObjSql();
	...
	public Libri findById(int id) {
		...
		String sql = "SELECT `idLibro`, `numPagine`,`anno`,`posizione`,`titolo`,"
				+ "`genere`,`autore`,`isbn`,`casaEditrice` " + " FROM `libri` WHERE `idLibro` = ?";
		boolean resp = connettore.sql(sql, campiString);
	...
	public List<Libri> findBykv(String k, String v) {
		String[] allowed = { "idLibro", "numPagine", "anno", "posizione", "titolo", "genere", "autore", "isbn",
				"casaEditrice" };
		...
		ObjSql connettore = new ObjSql();
		String sql = "SELECT `idLibro`, `numPagine`,`anno`,`posizione`,`titolo`,"
				+ " `genere`,`autore`,`isbn`,`casaEditrice` " + " FROM `libri` WHERE `" + k + "`=?";
	...
	public List<Libri> findAll() {
		...
		ObjSql connettore = new ObjSql();
		String sql = "SELECT `idLibro`, `numPagine`,`anno`,`posizione`,`titolo`,"
				+ "`genere`,`autore`,`isbn`,`casaEditrice` " + " FROM `libri` WHERE ?";
		boolean resp = connettore.sql(sql, campiString);
